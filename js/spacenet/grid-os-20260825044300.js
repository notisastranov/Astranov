(function () {
  ...
  function huntAround(product, city) {
  ...
  function wake() {
    say("…");
    grok("SpaceNet is open on the live globe. Greet in one short sentence. Ready for pizza, orders, and calls.")
      .then(function (t) {
        if (t) {
