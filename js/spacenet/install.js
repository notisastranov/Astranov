  ...
  if(!window.__snOfferRead){
    ...
    function offerCss(){
      ...
      s.textContent=
        ...
        "#sn-throw .strip{width:min(94vw,360px)!important;max-height:46vh!important;overflow:auto!important;font:600 15px/1.45 system-ui!important;padding:12px!important;z-index:5!important}"+
