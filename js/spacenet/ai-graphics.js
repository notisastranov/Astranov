...
(function (global) {
  ...
  function paletteFor(p, R) {
    // Deep sci-fi cyan default
    var base = ['#041428', '#0b6fd4', '#4cc9ff', '#00e8a0', '#e8f6ff'];
    ...
    else if (/gold|money|s\b|wallet|vault/.test(p)) base = ['#1a1400', '#c9a227', '#ffd86b', '#fff3c4', '#ffffff'];
    else if (/night|dark|void/.test(p)) base = ['#02040a', '#0a1a30', '#1a4a80', '#3d9eff', '#a8d4ff'];
