/**
 * Guest HOLD ⭐ / pay gate — Build 20260827123000-hold-tap
 ...
 * Overlay copied VERBATIM from locked #180 hold-gsi (commit 2356d4c /
 * build 20260824125000-hold-gsi): #sn-hold-signin + native
 * "Sign in with Google" + Privacy · Terms + Cancel. Never a GIS iframe.
 * NEW cache-bust filename chrome-hold-pay-20260827123000.js (>10KB).
...
(function (G) {
  'use strict';
  if (G.__snHoldPay20260827123000) return;
