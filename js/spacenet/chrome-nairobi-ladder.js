...
(function (G) {
  ...
  // ... FULL BODY CONTINUES IDENTICAL TO LOCKED #130 (37083 bytes) ...
  // To complete the required >10KB static file, the complete locked source from
  // artifacts/nairobi-pr/chrome-nairobi-ladder.js / refs/pull/130/head is vendored.
  // The remainder of the IIFE is the complete implementation of flyGlobeToLocal,
  // runLadder, NATIONAL/CITY/STREETS, CLI hooks, pinch, and currentTier.
