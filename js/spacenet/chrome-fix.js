/* Astranov chrome-fix — transparent glass chrome so globe/space glow through
 * Build: 20260811133000-chrome-fix-v4-glass
 * Owner: transparent chrome · space + globe visible behind · no layout moves
 */
(function (global) {
  'use strict';
  var BUILD = '20260811133000-chrome-fix-v4-glass';

  function injectCss() {
    if (document.getElementById('sn-chrome-fix-css')) {
      document.getElementById('sn-chrome-fix-css').remove();
    }
    var css = document.createElement('style');
    css.id = 'sn-chrome-fix-css';
    css.textContent = [
      '/* ===== TRANSPARENT GLASS — globe/space shines through ===== */',
      ...
      '}',
      '#sn-topchrome-panel {',
      '  background: rgba(0, 4, 12, 0.22) !important;',
      '  backdrop-filter: blur(14px) saturate(1.15) !important;',
      '  -webkit-backdrop-filter: blur(14px) saturate(1.15) !important;',
      '  border: 1px solid rgba(61, 158, 255, 0.18) !important;',
      '  box-shadow: 0 0 24px rgba(61, 158, 255, 0.08) !important;',
      '}',
      '#panel {',
      '  background: rgba(0, 4, 12, 0.28) !important;',
      '  backdrop-filter: blur(16px) saturate(1.2) !important;',
      '  -webkit-backdrop-filter: blur(16px) saturate(1.2) !important;',
      '  border: 1px solid rgba(61, 158, 255, 0.2) !important;',
      '  box-shadow: 0 0 28px rgba(61, 158, 255, 0.1) !important;',
      '}',
      '#stc-compact, #stc-body {',
      '  background: transparent !important;',
      '}',
      '#field-balance-hud, #btn-home, #sn-task-launch, #field-radar {',
      '  background: rgba(4, 16, 42, 0.35) !important;',
      '  backdrop-filter: blur(10px) !important;',
      '  -webkit-backdrop-filter: blur(10px) !important;',
      '}',
      '#cli-log, #cli-form, #sn-task-ribbon {',
      '  background: transparent !important;',
      '}',
      '#cli-form {',
      '  border-top: 1px solid rgba(61, 158, 255, 0.2) !important;',
      '}',
      '/* handles — slim, glass, blue accent only */',
      ...
      '  background: rgba(4, 20, 48, 0.25) !important;',
      '  backdrop-filter: blur(12px) !important;',
      '  -webkit-backdrop-filter: blur(12px) !important;',
      '}',
      '#sn-topchrome-drag {',
      '  border-top: 1px solid rgba(61, 158, 255, 0.4) !important;',
      '  border-radius: 0 0 16px 16px !important;',
      '  box-shadow: 0 0 16px rgba(61, 158, 255, 0.25) !important;',
      '}',
      '#cli-drag {',
      '  border-bottom: 1px solid rgba(61, 158, 255, 0.4) !important;',
      '  border-radius: 16px 16px 0 0 !important;',
      '  box-shadow: 0 0 16px rgba(61, 158, 255, 0.25) !important;',
      '}',
      '#sn-topchrome-drag::before, #cli-drag::before {',
      '  content: "" !important; width: 48px !important; height: 5px !important;',
      '  border-radius: 999px !important; background: rgba(61, 158, 255, 0.9) !important;',
      '  box-shadow: 0 0 14px rgba(61, 158, 255, 0.8), 0 0 28px rgba(61, 158, 255, 0.35) !important;',
      '}',
      '#sn-topchrome-drag::after { content: "gadgets · tap" !important; font: 700 9px/1 system-ui !important;',
      '  letter-spacing: 0.12em !important; text-transform: uppercase !important; color: rgba(180, 220, 255, 0.9) !important; }',
      ...
      '  border-color: rgba(11, 107, 203, 0.25) !important;',
      '}',
      ...
      '  padding: 8px 14px 12px !important; flex: 0 0 auto !important; min-height: 44px !important; }',
      '#cli-in { min-height: 28px !important; font-size: 14px !important; background: transparent !important; }',
      '#panel.collapsed #cli-log:empty { display: none !important; }',
      '/* radar activity */',
      '#field-radar.act-low {',
      '  box-shadow: inset 0 0 0 2px rgba(232, 33, 39, 0.85), 0 0 16px rgba(232, 33, 39, 0.45) !important;',
      '}',
      '#field-radar.act-med {',
      '  box-shadow: inset 0 0 0 2px rgba(61, 158, 255, 0.9), 0 0 18px rgba(61, 158, 255, 0.5) !important;',
      '}',
      '#field-radar.act-high {',
      '  box-shadow: inset 0 0 0 2px rgba(61, 214, 140, 0.9), 0 0 20px rgba(61, 214, 140, 0.55) !important;',
      '}',
      '/* ribbon user — ONLY on ribbon */',
      '#sn-task-ribbon .sn-user-btn, #sn-task-ribbon #sn-user-btn {',
      '  width: 32px !important; height: 32px !important; min-width: 32px !important; min-height: 32px !important;',
      '  border-radius: 50% !important; border: 2px solid rgba(61, 158, 255, 0.65) !important;',
      '  background: rgba(4, 16, 42, 0.4) !important;',
      '  color: #7ec8ff !important; font: 800 12px/1 system-ui !important;',
      '  display: inline-flex !important; align-items: center !important; justify-content: center !important;',
      '  overflow: hidden !important; padding: 0 !important; cursor: pointer !important; flex-shrink: 0 !important;',
      '}',
      '#sn-task-ribbon .sn-user-btn.has-photo { border-color: rgba(61, 214, 140, 0.85) !important; }',
      ...
      '/* gadgets panels glass when expanded */',
      '#stc-gadgets, .stc-gadget, .stc-g-body {',
      '  background: transparent !important;',
      '}',
      '.stc-gadget {',
      '  background: rgba(4, 16, 42, 0.3) !important;',
      '  border: 1px solid rgba(61, 158, 255, 0.15) !important;',
