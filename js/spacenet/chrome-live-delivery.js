/* Astranov live delivery P0 — Build 20260817101000
 * 1) vendors bbox delivery_enabled · no Astranov Kitchen unless ?sn-debug=1
 * 2) Menus Google/Rhodes EUR · no DEFAULT_PREFS/Super Greek
 * 3) Wallet = profiles.eur_balance as Æ (1 EUR) · log avc_transactions · guest 0 · no hardcoded 80
 */
(function (global) {
  'use strict';
  ...
  function menuForShopName(name, category) {
    ...
    if (/kalamari|calamari|seafood|fish|thalassa|nireas|psarotaverna/i.test(n + c))
      return [it('Grilled kalamari', 14.5, 'Fresh · lemon'), it('Fried kalamari', 12.0, ''), it('Sea bream', 18.0, ''), it('Greek salad', 8.5, ''), it('House white 500ml', 9.0, '')];
