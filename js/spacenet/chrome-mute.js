/* Astranov mute · Build 20260824064000-research-stay2
 * Kill beeps + load chrome-research-stay (paid mind in CLI, camera stays put).
 * Does NOT load chrome-guest-pizza-hunt (#127), chrome-call-arc (#129),
 * chrome-nairobi-ladder (#130), chrome-kalithea-village (#131),
 * or chrome-guest-laptop-hunt (#132).
