/* Astranov mute · Build 20260827133000-hold-chip
 * PATCH PR #221 only. First HOLD tap AND CLI `hold` mount #sn-hold-signin
 * (display:flex) with Sign in with Google + Privacy · Terms · Cancel.
 * Chip listeners re-bound on EVERY showChip. Cancel only unmounts.
 * Do not merge. Do not land. Do not touch github.io.
 * Earth: chrome-place-earth-20260827114000.js (FULL JS >10KB).
 * Pizza: chrome-guest-pizza-cam-20260827121000.js (FULL JS >10KB).
 * HOLD:  chrome-hold-pay-20260827133000.js (FULL JS >10KB).
...
(function (global) {
  ...
  function loadChain() {
    ...
    loadScript("/js/spacenet/chrome-hold-pay-20260827133000.js", "data-sn-hold-pay");
  }
