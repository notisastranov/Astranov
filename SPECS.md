...
| **Sim-33 swarm** | Owner-dev: **33 agents on Rhodes Island, Greece** (12 client · 8 vendor · 8 driver · 5 ambassador). CLI `sim live|stop`. `sim:true` — hidden when stopped. | Dev / owner |
