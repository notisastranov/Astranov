/* SpaceNet SW 4142 — shell network-first, tiles on the device. Never serve HTML as JS. */
var CACHE = "sn-shell-4142";
...
function withShell(html) {
  ...
  if (html.indexOf("leave-flat.js") === -1) {
    html = html.replace(/leaflet\.js(\?v=[^"']*)?"><\/script>/, "leaflet.js$1\"></script>\n<script src=\"/js/spacenet/voice.js?v=4142\"></script>\n<script src=\"/js/spacenet/leave-flat.js?v=4142\"></script>\n<script src=\"/js/spacenet/wallet.js?v=4142\"></script>\n<script src=\"/js/spacenet/power.js?v=4142\"></script>\n<script src=\"/js/spacenet/task-throw.js?v=4142\"></script>");
  ...
  if (html.indexOf("pay-now.js") === -1 && html.indexOf("wallet.js") !== -1) {
    html = html.replace(/wallet\.js(\?v=[^"']*)?"><\/script>/, "wallet.js$1\"></script>\n<script src=\"/js/spacenet/pay-now.js?v=4142\"></script>");
  }
  if (html.indexOf("tree.js") === -1 && html.indexOf("labor.js") !== -1) {
    html = html.replace(/labor\.js(\?v=[^"']*)?"><\/script>/, "labor.js$1\"></script>\n<script src=\"/js/spacenet/tree.js?v=4142\"></script>");
  }
  if (html.indexOf("/js/spacenet/auth.js") === -1 && html.indexOf("app.js") !== -1) {
    html = html.replace(/spacenet\/app\.js(\?v=[^"']*)?"><\/script>/, "spacenet/app.js$1\"></script>\n<script src=\"/js/spacenet/auth.js?v=4142\"></script>\n<script src=\"/js/spacenet/order-menu.js?v=4142\"></script>\n<script src=\"/js/spacenet/support-gate.js?v=4142\"></script>\n<script src=\"/js/spacenet/approvals.js?v=4142\"></script>");
  }
  return html;
}
