/* SpaceNet SW 4110 — shell network-first, tiles on the device. Never serve HTML as JS. */
var CACHE = "sn-shell-4110";
...
function withShell(html) {
  ...
  if (html.indexOf("leave-flat.js") === -1) {
    html = html.replace(/leaflet\.js(\?v=[^"']*)?"><\/script>/, "leaflet.js$1\"></script>\n<script src=\"/js/spacenet/voice.js?v=4110\"></script>\n<script src=\"/js/spacenet/leave-flat.js?v=4110\"></script>\n<script src=\"/js/spacenet/wallet.js?v=4110\"></script>\n<script src=\"/js/spacenet/task-throw.js?v=4110\"></script>");
  ...
  if (html.indexOf("/js/spacenet/auth.js") === -1 && html.indexOf("app.js") !== -1) {
    html = html.replace(/spacenet\/app\.js(\?v=[^"']*)?"><\/script>/, "spacenet/app.js$1\"></script>\n<script src=\"/js/spacenet/auth.js?v=4110\"></script>\n<script src=\"/js/spacenet/order-menu.js?v=4110\"></script>\n<script src=\"/js/spacenet/support-gate.js?v=4110\"></script>\n<script src=\"/js/spacenet/approvals.js?v=4110\"></script>");
